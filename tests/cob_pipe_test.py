...
class CobPipeTest(unittest.TestCase):
    ...
    def test__get_jobs_to_create__result_job_list(self):
        self.assertEqual(self.cp.get_jobs_to_create(), {'normal': ['test_repo_1', 'test_repo_3'], 'nongraphics_test': ['test_repo_1'], 'app': ['test_repo_1'], 'bringup': ['test_repo_1'], 'down': ['test_repo_1'], 'release': ['test_repo_1'], 'graphics_test': ['test_repo_1'], 'highlevel': ['test_repo_1']})
