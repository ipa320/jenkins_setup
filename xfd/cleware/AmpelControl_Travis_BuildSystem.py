...
def extract_build_query(file_path):
	...
	with open(file_path) as fp:
			...
			if "git:" in line:
				...
				user = line.split("'https://github.com/",1)[1]
...
def extract_travis_build_states(path):
        '''
	...
	url_string = None
        ...
        private_domain = "com"
        public_domain = "org"
	auth_token = "BfWy2qnSEU7k5fBMRxsE"
...
if __name__ == "__main__":
	...
	ampel.set_state(ampel_state)
        ...
        while True:
		try:
			travis_state = extract_travis_build_states(options.path)
